...
export function getCharacters(props?: getCharactersProps) {
  ...
  const upperCaseCharacters = props?.upperCaseCharacters ?? DEFAULT_UPPERCASE_CHARACTERS;
  const lowerCaseCharacters = props?.lowerCaseCharacters ?? DEFAULT_LOWERCASE_CHARACTERS;
  const specialCharacters = props?.specialCharacters ?? DEFAULT_SPECIAL_CHARACTERS;
  const numberCharacters = props?.numberCharacters ?? DEFAULT_NUMBER_CHARACTERS;
